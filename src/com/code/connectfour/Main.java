...
public class Main extends Application {
    ...
    private void aboutMe() {
        ...
        alert.setHeaderText("Vishal Modani");
        alert.setContentText("I love to play around with the code and create games. Connect4 is one them." +
                "In the free time i like to spend time with nears and dears.");
    ...
    private void aboutGame() {
        ...
        alert.setContentText("Connect Four is a two-player connection game" +
                ...
                "by playing the right moves. Connect Four is a two-player connection " +
